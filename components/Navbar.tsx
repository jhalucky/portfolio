...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-white/70 dark:bg-black/70 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6 sm:px-8">
        ...
        <nav className="flex items-center gap-6 text-sm">
          ...
          <Link href="#about" className="hover:text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">About</Link>
          ...
          <button
            ...
            className="hidden md:inline-flex h-8 w-8 items-center justify-center rounded-md border hover:opacity-80"
