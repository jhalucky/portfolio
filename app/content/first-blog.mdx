...
date: "2025-08-23"
author: "Lucky Jha"
image: "/images/how-i-started.png"
description: "My journey from a complete beginner to a passionate developer, exploring the world of programming and discovering my love for coding."
---
...
> *"The best time to plant a tree was 20 years ago. The second best time is now."* - This quote perfectly describes my coding journey. I started late, but I started.

<img src="/images/how-i-started.png" alt="Beginning of my coding journey" className="rounded-lg shadow-md my-6" />
...
<img src="/images/love-for-python.png" alt="Python programming journey" className="rounded-lg shadow-md my-6" />

### My First Python Program

```python
# My very first "Hello World" program
print("Hello, World!")
print("I am learning to code!")
```

Simple, right? But that moment when I saw those words appear on the screen — it was pure magic. From there, I started experimenting with more complex patterns:

```python
# My first pattern program
for i in range(5):
    print("*" * (i + 1))
```
...
Once the curiosity kicked in, I couldn't stop myself from exploring further. I started exploring more YouTube and Google, asking "how does this work?" Soon, I discovered there are not only Python in the game — there are more programming languages! I explored Java, C++, and JavaScript. I was amazed at how these languages were used to build different parts of the digital world: some for system-level programming, some for building applications, and some for creating the websites we use daily.  
...
### The Language Spectrum I Discovered:

- **Python**: My first love - simple, readable, powerful
- **Java**: Enterprise-level applications and Android development
- **C++**: System programming and game development
- **JavaScript**: Web development and interactive experiences
...
This quote resonates with me because coding taught me to question everything and find better solutions.
...
<img src="/images/love-for-python.png" alt="My current tech stack and tools" className="rounded-lg shadow-md my-6" />
...
- **Embrace the learning curve** - Every expert was once a beginner
- **Build projects** - Theory is great, but practice makes perfect
