      ...
      <main className="mx-auto max-w-5xl space-y-20 px-6 py-10 sm:px-8">
        ...
        <section id="about" className="space-y-3">
          ...
          <p className="text-foreground/80">
            ...
            architecture, smooth performance, and great DX.<br></br>
            When I’m not coding, you’ll probably find me sketching new ideas, brainstorming the next side project, or diving into tech communities to learn and share knowledge.

At the core, I just love building cool stuff that makes people say “wow!”
          </p>
        </section>
